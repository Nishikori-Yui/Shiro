  ...
  return (
    ...
    >
      <div className="space-y-2 leading-relaxed">
        ...
        <p>
          當您打開這個頁面時，將會自動建立 WebSocket
          連接，並在成功連接後，伺服器會推送您正在瀏覽的頁面的人數。
        </p>
        <p>
          WebSocket
          用於通報站長在站點上的即時活動，包括但不限于文章的發佈和更新。
        </p>
...
const RoomsInfo = () => {
  ...
  if (data.length === 0)
    return <div className="text-gray-500">還沒有小夥伴在閱讀文章哦~</div>
  return (
    <div className="lg:max-w-[400px]">
      <div className="mb-2 text-sm font-medium">下面的內容正在被閱讀：</div>
